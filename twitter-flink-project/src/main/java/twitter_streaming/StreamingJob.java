...
public class StreamingJob {
   ...
   private static Properties getTwitterCredentials(){
      ...
      twitterCredentials.setProperty(TwitterSource.CONSUMER_KEY, "myKey");
      twitterCredentials.setProperty(TwitterSource.CONSUMER_SECRET, "myKey");
      twitterCredentials.setProperty(TwitterSource.TOKEN, "my-token");
      twitterCredentials.setProperty(TwitterSource.TOKEN_SECRET, "my-token");
