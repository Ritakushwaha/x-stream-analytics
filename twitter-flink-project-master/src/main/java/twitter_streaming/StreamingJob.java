...
public class StreamingJob {
	...
	private static Properties getTwitterCredentials(){
		...
		twitterCredentials.setProperty(TwitterSource.CONSUMER_KEY, "obQRWkMGxeM5HTgigVM6uK91V");
		twitterCredentials.setProperty(TwitterSource.CONSUMER_SECRET, "BTyRtsvKZLrWEOeOaF3nYSNd74i0LkRyNNumfn33a5xPKki8B1");
		twitterCredentials.setProperty(TwitterSource.TOKEN, "811205561643515904-89kdYOal4whT4hoyzg5KMqpDu8Mx1fK");
		twitterCredentials.setProperty(TwitterSource.TOKEN_SECRET, "zMVNpFtHI9fVvtuP0LnomptaHhEQ7aKEWGwjV3iW504Zo");
